...
class AuthController
{
    ...
    public function login(): void
    {
        ...
        Session::setFlash('success', 'Bienvenue, ' . htmlspecialchars($user['nom']) . ' !');
        header('Location: ' . APP_URL . '/?page=dashboard');
        exit();
    }
    ...
    public function register(): void
    {
        ...
        Session::set('old_input', ['nom' => $nom, 'email' => $email, 'role' => $role]);
        ...
        if (!in_array($role, ['eleve', 'enseignant', 'parent', 'administrateur']))
        ...
        // Création du compte
        $created = $this->userModel->create($nom, $email, $password, $role);
